...
const withSpecificPointerNumbers = require('../../src/withSpecificPointerNumbers');
...
describe('withSpecificPointerNumbers', function() {
  ...
  it('filter out the touches with incorrect touch numbers', function(done) {
    ...
    withSpecificPointerNumbers(1, Rx.Observable.from(source), getInitialLayout)
      .toArray().subscribe(function(results) {
        results.should.have.lengthOf(1);
        withSpecificPointerNumbers(2, Rx.Observable.from(source), getInitialLayout)
          .toArray().subscribe(function(results) {
